  ...
  return (
    <a
      ...
      className="fixed bottom-4 left-4 z-50 
                 ...
                 h-12 w-12 sm:h-16 sm:w-16 hover:sm:w-44 
                 rounded-full shadow-lg flex items-center overflow-hidden
                 transition-all duration-300 group"
    >
      <div className="flex items-center justify-start pl-2 sm:pl-3 w-full">
        {/* Ícono de WhatsApp */}
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 32 32"
          fill="currentColor"
          className="w-8 h-8 sm:w-10 sm:h-10 flex-shrink-0 text-white transition-transform duration-300 group-hover:scale-110 animate-bounce-slow"
        >
        ...
        {/* Texto que aparece al hacer hover (solo visible en desktop) */}
        <span className="hidden sm:inline whitespace-nowrap ml-2 opacity-0 group-hover:opacity-100 text-white transition-opacity duration-300 text-base">
          Contáctanos
        </span>
      </div>
    </a>
